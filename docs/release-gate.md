...
| Subtitle | PASS (unit) / **PASS live Layout A** (2026-09-08) | `subtitle-multilang.test.ts`; live default-set COMPLETED (`docs/manual-acceptance-p4.md`). Residual: P4-T3/T4 explicit, Layout B/C, full §50 5×3 matrix. |
